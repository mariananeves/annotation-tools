...
def ArgumentParser():
    ...
    parser.add_argument('--free', action='store_true', #type=str, choices=['yes','no'], #default='yes',
    ...
    parser.add_argument('--last_publication', type=int, choices=range(1900,2100), #default='2013',
                        help='the minimum year for the last publication of the tool')
    parser.add_argument('--citations', type=int, choices=range(0,1000), #default='30',
                        help='the minimum number of citations that the publications of the tools should have')
    parser.add_argument('--citations_corpora', type=int, choices=range(0,1000), #default='10',
                        help='the minimum number of citations for corpus construction that the publications of the tools should have')
    # criteria: technical
    parser.add_argument('--last_version', type=int, choices=range(1900,2100), #default='2017',
    ...
    # criteria: functional
    parser.add_argument('--multi_label', action='store_true', #type=str, choices=['yes','no'], #default='yes',
                        help='whether the tool allows annotations with multiple labels')
    parser.add_argument('--document_level', action='store_true', #type=str, choices=['yes','no'], #default='yes',
    ...
    parser.add_argument('--preannotations', action='store_true', #type=str, choices=['yes','no'], #default='yes',
                        help='whether the tool supports pre-annotations')
    parser.add_argument('--medline_pmc', action='store_true', #type=str, choices=['yes','no'], #default='yes',
                        help='whether the tool supports integration with either Medline or PMC')
    parser.add_argument('--full_texts', action='store_true', #type=str, choices=['yes','no'], #default='yes',
                        help='whether the tool supports the annotation of full texts')
    parser.add_argument('--partial_save', action='store_true', #type=str, choices=['yes','no'], #default='yes',
    ...
    parser.add_argument('--users_teams', action='store_true', #type=str, choices=['yes','no'], #default='yes',
